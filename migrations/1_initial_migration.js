...
module.exports = async function (deployer, network, accounts) {
  if (network === "development") {
    await deployer.deploy(Bridge, "Ion", "ION", [accounts[0]]);
  }

 if (network === "goerli" || network === "bsc_testnet") {
   console.log('Deploy from ' + accounts[0]);
   await deployer.deploy(Bridge, "Ion", "ION", ['0xbE4Eb1b396062D062b90b4caeE19ECb1a59265D1',
 ...
 if (network === "eth_mainnet" || network === "bsc_mainnet") {
   await deployer.deploy(Bridge, "Ion", "ION", ['0xC4c9bd836ab8b446519736166919e3d62491E041',
